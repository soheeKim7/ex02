		...
		<div class="card-header py-3">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2-5" style="text-align:right">
					<form action="/board/goodclick" method="get" id="goodclickForm" style="float:left;margin-right: 5px;">			
						<input type="hidden" name="bno" value="${board.bno }">		
						<input type="hidden" name="pageNum" value="${cri.pageNum }">		
						<input type="hidden" name="amount" value="${cri.amount }">		
						<input type="hidden" name="badCheck" id="badCheck" value="${badCheck }">
						<button class="btn btn-secondary" id="goodclickButton" >
					...
					<form action="/board/badclick" method="get" id="badclickForm" style="margin-left: 5px;">			
						<input type="hidden" name="bno" value="${board.bno }">		
						<input type="hidden" name="pageNum" value="${cri.pageNum }">		
						<input type="hidden" name="amount" value="${cri.amount }">		
						<input type="hidden" name="goodCheck" id="goodCheck" value="${goodCheck }">
						<button class="btn btn-danger" id="badclickButton">
							...
							<span class="text">싫어요 ${board.badclick } 개</span>
						</button>		
					</form>					
				</div>
...
<script>
	...
	$("#goodclickButton").on("click",function(){
		replyService.goodclick(1244L,function(data){		
	...
	replyService.goodclick(1244,function(data){		
		console.log("일단 데이터 잘 받아오나 테스트 해보쟈 : ",data);
		if(data){
			alert("이미 좋아요를 눌렀습니다.")
		}else{
